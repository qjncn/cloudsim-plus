 ...
 * will be only one Cloudlet per VM. Other Cloudlets will be in a waiting list.     一个VM只有一个cloudlet
 ...
 * order. If actual priorities are defined for Cloudlets, they are just ignored     本算法实现的时候忽略了cloudlet的优先级
